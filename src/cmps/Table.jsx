...
export function Table({ board, group, onSaveBoard, progress, onRemove, onDuplicate }) {
    ...
    return (
        <section className="table-preview main-layout full flex align-center justify-center">
                    ...
                    {(provided) => (
                        <div {...provided.droppableProps} ref={provided.innerRef} className=" main-layout full">
                            ...
                            <div className="group-footer full main-layout">
                                <div className="add-task full main-layout" onMouseEnter={() => setOpacity('')} onMouseLeave={() => setOpacity('80')}>
                                    <table className="table-container table last" style={{ borderColor: group.style.backgroundColor + opacity }}>
